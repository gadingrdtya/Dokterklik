  ...
  return (
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        <button className={`py-1 px-3 border rounded text-sm transition-all sm:hidden ${showFilter ? 'bg-[#00B8BA] text-white' : ''}`} onClick={() => setShowFilter(prev => !prev)}>Filters</button>
